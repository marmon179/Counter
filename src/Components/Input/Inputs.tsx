...
export function Inputs(props: InputPropsType) {
    const errorStart = (props.maxValue < 0) || (props.startValue === props.maxValue) ? s.error : s.input
    const errorMax = (props.startValue < 0) || (props.startValue >= props.maxValue) ? s.error : s.input
